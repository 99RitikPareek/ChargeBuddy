  ...
  <div class="main-content">
    ...
    <div class="login-container">
      ...
      <div class="login-form">
        <h2>Sign In</h2>
        <strutsns:form action="signinaction_logicalcode_action.action" method="post">
<!--          <img src="images/loginimg.jpg" class="loginimg" alt="Login Icon"><br><br>-->

          <strutsns:textfield  name="customerId" theme="simple" cssClass="texttheme">
            
          </strutsns:textfield>

          <strutsns:password name="password" theme="simple" cssClass="texttheme">
