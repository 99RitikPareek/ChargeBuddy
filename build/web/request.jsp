  ...
  <div class="main-content">
    ...
    <div class="login-container">
      ...
      <div class="login-form">
        <h2>REQUEST FOR CHARGING/PURCHASE</h2>
        <strutsns:form action="requestaction_logicalcode_action.action" method="post">

            <table align="center" cellspacing="3px" cellpadding="2px">
        <tr><td><strutsns:textfield label="Id"  name="customerId" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns_dojo:datetimepicker  label="Delivery date"  name="deliveryDate" cssClass="texttheme"/>                    </td></tr>
        <tr><td><strutsns:combobox
                list="{'Mobile','Vechile','Cable','Adapter'}" 
                label="Category" name="fuelType" 
                cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:textfield label="Quantity"  name="quantity" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:textfield label="Location"  name="location" cssClass="texttheme"/></td></tr>
        <tr align="center"><td colspan="2"><strutsns:submit value="SEND" theme="simple" cssClass="buttontheme"/>
        </td></tr>
        </table>
