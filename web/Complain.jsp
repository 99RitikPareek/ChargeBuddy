  ...
  <div class="main-content">
    ...
    <div class="login-container">
      ...
      <div class="login-form">
        ...
        <strutsns:form action="Complainaction_logicalcode_action.action" method="post">
  <table align="center" cellspacing="3px" cellpadding="2px">
    <tr><td><strutsns:textfield label="Customer Id"  name="customerId" cssClass="texttheme"/></td></tr>
    ...
    <tr align="center">
      <td colspan="2"><strutsns:submit value="SEND" theme="simple" cssClass="buttontheme"/></td>
    </tr>
  </table>
</strutsns:form>
