  ...
  <div class="main-content">
    ...
    <div class="login-container">
      ...
      <div class="login-form">
        ...
        <strutsns:form action="feedbackaction_logicalcode_action.action" method="post">

            <table align="center" cellspacing="3px" cellpadding="2px">
        <tr><td><strutsns:textfield label="Customerid"  name="customerId" cssClass="texttheme"/></td></tr>
        <tr><td><strutsns:textarea label="Complain"  name="complain" cssClass="texttheme"/></td></tr>
