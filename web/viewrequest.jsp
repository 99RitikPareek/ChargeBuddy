...
<!--        <a href="#">Give</a>
    ...
    <div class="main-header">
      ...
      <ul class="nav-menu">
        <li><a href="abouturl.action">ABOUT</a></li>
        <li><a href="settingurl.action">SETTING</a></li>
        <li><a href="viewcomplainurl.action">VIEW COMPLAIN</a></li>
        <li><a href="viewfeedbackurl">VIEW FEEDBACK</a></li>
        <li><a href="viewrequesturl">VIEW REQUEST</a></li>
      </ul>
    </div>
  </header>
